class Gem::Commands::MigrateCommand < Gem::AbstractCommand
  ...
  def description
    "Migrate a gem your own from Rubyforge to #{DESTINATION_NAME}."
  end
  ...
  def find(name)
    ...
    when Net::HTTPSuccess
      ...
      say "This gem is currently not hosted on #{DESTINATION_NAME}."
      terminate_interaction
    end
  end
  ...
  def check_for_approved
    say "Asking #{DESTINATION_NAME} to verify the upload..."
